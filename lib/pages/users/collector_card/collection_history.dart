...
class _CollectionHistoryPageState extends State<CollectionHistoryPage> {
  ...
  String _searchQuery = "";
  bool _isSearching = false; // Track if search field is active
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(_isSearching ? Icons.close : Icons.arrow_back, color: kWhite),
          onPressed: () {
            if (_isSearching) {
              setState(() {
                _isSearching = false;
        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => [
              ...
              const PopupMenuItem(value: "Reg No", child: Text("Sort by Reg No")),
              const PopupMenuDivider(),
              const PopupMenuItem(value: "Ascending", child: Text("Ascending")),
              const PopupMenuItem(value: "Descending", child: Text("Descending")),
            ],
          ),
        ],
      ),
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          filteredHistory.sort((a, b) {
            ...
            switch (_sortField) {
              case SortField.date:
                DateTime dateA = (dataA['createdAt'] as Timestamp?)?.toDate() ?? DateTime.now();
                DateTime dateB = (dataB['createdAt'] as Timestamp?)?.toDate() ?? DateTime.now();
          ...
          if (filteredHistory.isEmpty) return _emptyState();
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              DateTime createdAt = (data['createdAt'] as Timestamp?)?.toDate() ?? DateTime.now();
